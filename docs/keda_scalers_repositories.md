...
- Scalers source GitHub URL: [https://github.com/kedacore/external-scalers/tree/master/khulnasoft](https://github.com/kedacore/external-scalers/tree/master/khulnasoft)
- Repository URL used in Artifact Hub: `https://github.com/kedacore/external-scalers/khulnasoft` (please note how the *tree/master* part is not used)
