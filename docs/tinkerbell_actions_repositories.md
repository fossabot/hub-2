...
- Actions source GitHub URL: [https://github.com/tinkerbell/hub/tree/khulnasoft-manifests/actions](https://github.com/tinkerbell/hub/tree/khulnasoft-manifests/actions)
- Repository URL used in Artifact Hub: `https://github.com/tinkerbell/hub/actions` (please note how the *tree/khulnasoft-manifests* part is not used)
