...
require (
	...
	github.com/open-policy-agent/gatekeeper/v3 v3.13.0-beta.1
...
require (
	...
	github.com/open-policy-agent/frameworks/constraint v0.0.0-20230411224310-3f237e2710fa // indirect
	...
	github.com/spiffe/spire-api-sdk v1.6.3 // indirect
...
replace (
	...
	knative.dev/pkg => github.com/tegioz/knative-pkg v0.0.0-20230516120619-31481a3b1e35
)
